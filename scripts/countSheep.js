const zeroNum = new Float32Array([
	0.0,
	0.0,
	0.0,
	0.0,
...
var drawApp = new PIXI.Application(pScale1 * size1, pScale1 * size1, {
	transparent: true
});
var responseApp = new PIXI.Application(pScale1 * size1, pScale1 * size1, {
	transparent: true
});
